    ...
    <div className="login-content">
      <div className="form-container">
        ...
        <div className="error-container">
          {(() => {
            switch (authState) {
              ...
              case 3:
                return <p className="error-msg">Passwords don't match</p>;
              case 4:
        ...
        <form>
          ...
          <div className="form-group">
            <input type="password" id="rpassword" name="rpassword" placeholder="Repeat password" onChange={handleRpasswordChange} />
          </div>
          Already have an account?
          <div className="form-submit">
            <a href='/login' className="button-password-reset">Login</a>
